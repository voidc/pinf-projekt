...
@Service public class AsyncMailService {
	...
	@Value("${gwe.reset-token-expiry}") private long tokenExpiry;

	@Autowired public AsyncMailService(JavaMailSender mailSender, TokenGenerator tokenGen,
	...
	@Async public void sendMail(MimeMessagePreparator mail) {
		try {
